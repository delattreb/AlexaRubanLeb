...
uint8_t effects[EFFECT_MAX] = {FX_MODE_STATIC, FX_MODE_COLOR_WIPE, FX_MODE_RUNNING_LIGHTS, FX_MODE_COMET, FX_MODE_FIREWORKS, FX_MODE_TWINKLEFOX, FX_MODE_FADE, FX_MODE_SCAN, FX_MODE_DUAL_SCAN};
